...
class SetCommand : public BaseCommand {
 ...
 public:
  SetCommand(BaseDataStore &store, string k, string val, optional<int32_t> ex, optional<bool> nx);
  ...
  static SetCommand parseSetCommand(const std::vector<std::string> parts, BaseDataStore &store);
